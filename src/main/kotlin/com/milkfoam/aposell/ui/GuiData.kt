...
import com.milkfoam.aposell.hook.PlaceholderAPI
...
class GuiData(
        ...
        opener.openMenu<Basic>(title = title.colored()) {
            ...
            onClick('-') { clickEvent ->
                ...
                if (vaultAllMoney > 0 || pointAllMoney > 0) {
                    ...
                    PlaceholderAPI.addPoint(opener, pointAllMoney)
                    opener.sendLang(
                        "Sell-success",
                        prefix,
                        vaultAllMoney,
                        ...
                        PlaceholderAPI.getPoint(opener)
                    )
                }
            }
    ...
    fun openEvent() {
        ...
        when (openType) {
            ...
            "console" -> {
                Bukkit.dispatchCommand(Bukkit.getConsoleSender(), openEvent)
            }
